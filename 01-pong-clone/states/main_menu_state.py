...
class MainMenuState:
  ...
  def render(self):
    ...
    # self.game_handler.surface.blit(self.button_1_text_surface, (self.button_1_x_pos, self.button_1_y_pos))
    # self.game_handler.surface.blit(self.button_2_text_surface, (self.button_2_x_pos, self.button_2_y_pos))
    # self.game_handler.surface.blit(self.button_options_text_surface, (self.button_options_x_pos, self.button_options_y_pos))
    # self.game_handler.surface.blit(self.button_quit_text_surface, (self.button_quit_x_pos, self.button_quit_y_pos))
